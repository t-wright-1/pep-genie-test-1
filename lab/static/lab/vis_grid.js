    ...
    canvas.onclick = function (e) {
        if (gridDrawn == true) {
            ...
            if (count !== 1 && gridDrawn == false) {
                ...
                handleSe.style = "display: block; position: absolute;"
...
function saveCoordsSubmit() {
    ...
    let x1 = (gridRect.left - canvasRect.left + x_factor)/canvasRect.width;
    let y1 = (gridRect.top - canvasRect.top + y_factor)/canvasRect.height;
    let x2 = (gridRect.right - canvasRect.left + x2_factor)/canvasRect.width;
    let y2 = (gridRect.bottom - canvasRect.top + y2_factor)/canvasRect.height;
